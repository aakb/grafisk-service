...
class OrderMessagesForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // User email settings.
    $form['user_email_settings_wrapper']['user_email_settings'] = [
      '#type' => 'vertical_tabs',
      '#description' => t('Messages sent to the users email address.'),
    ];

    // Email settings.
    $form['user_email_settings']['order_created_email'] = [
    ...
    $form['user_email_settings']['order_created_email']['order_created_email_subject'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Email subject'),
      '#default_value' => $settings->get('order_created_email_subject'),
    ];

    $form['user_email_settings']['order_created_email']['order_created_email_body'] = [
      '#type' => 'text_format',
    ...
    $form['user_email_settings']['order_created_email']['order_created_email_from'] = [
      '#type' => 'textfield',
      '#required' => TRUE,
    ...
    $form['user_email_settings']['order_created_email']['order_created_email_from_name'] = [
      '#type' => 'textfield',
      '#required' => TRUE,
    ...
    $form['user_email_settings']['order_created_email']['order_created_email_submit'] = [
      '#type' => 'submit',
      '#value' => t('Save order created email settings'),
      '#weight' => 1,
      '#submit' => ['::order_created_email_submit'],
    ];

    $form['user_email_settings']['theme'] = [
      '#title' => $this->t('Theme'),
      '#type' => 'details',
      '#weight' => '87',
      '#group' => 'user_email_settings',
    ...
    $form['user_email_settings']['theme']['email_theme'] = [
      '#type' => 'select',
      '#title' => $this->t('Theme'),
    ...
    $form['user_email_settings']['theme']['theme_submit'] = [
      '#type' => 'submit',
    ...
    // Admin settings.
    $form['admin_email_settings_wrapper'] = [
    ...
    $form['admin_email_settings_wrapper']['admin_email_settings'] = [
      '#type' => 'vertical_tabs',
      '#description' => t('Messages sent to a shared administration email account.'),
    ];

    // Email settings.
    $form['admin_email_settings']['admin_order_created_email'] = [
    ...
    $form['admin_email_settings']['admin_order_created_email']['admin_order_created_email_subject'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Email subject'),
      '#default_value' => $settings->get('admin_order_created_email_subject'),
    ];

    $form['admin_email_settings']['admin_order_created_email']['admin_order_created_email_body'] = [
      '#type' => 'text_format',
      '#title' => $this->t('Email body'),
    ...
    $form['admin_email_settings']['admin_order_created_email']['admin_order_created_email_to'] = [
      '#type' => 'textfield',
      '#required' => TRUE,
    ...
    $form['admin_email_settings']['admin_order_created_email']['admin_order_created_email_submit'] = [
      '#type' => 'submit',
      '#value' => t('Save admin email settings'),
      '#weight' => 1,
      '#submit' => ['::admin_order_created_email_submit'],
    ];

    // Admin email theme settings.
    $form['admin_email_settings']['admin_theme'] = [
      '#title' => $this->t('Theme'),
      '#type' => 'details',
      '#weight' => '87',
      '#group' => 'admin_email_settings',
    ...
    $form['admin_email_settings']['admin_theme']['admin_email_theme'] = [
      '#type' => 'select',
      '#title' => $this->t('Theme'),
      '#options' => $installed_themes_options,
    ...
    $form['admin_email_settings']['admin_theme']['admin_theme_submit'] = [
      '#type' => 'submit',
      '#value' => t('Save admin email theme settings'),
      '#weight' => 1,
      '#submit' => ['::admin_theme_submit'],
    ];
